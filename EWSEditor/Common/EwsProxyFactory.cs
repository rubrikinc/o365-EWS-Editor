...
namespace EWSEditor.Exchange
{
    public class EwsProxyFactory
    {
        ...
        public static bool? UseAppSecretOAuth = null;
        public static string AppSecretoAuthClientId = string.Empty;
        public static string AppSecretoAuthAppSecret = string.Empty;
        public static string AppSecretoAuthAuthority = string.Empty;
        public static string AppSecretoAuthTenantId = string.Empty;
        public static string AppSecretoAuthScope = string.Empty;
