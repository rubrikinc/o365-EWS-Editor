    ...
    public partial class ServiceDialog : DialogForm
    {
        ...
        private void BtnOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if(rdoAppSecretOauth.Checked)
                {
                    EwsProxyFactory.AuthenticationMethod = RequestedAuthType.AppSecretOAuth;
                }
                ...
                switch (EwsProxyFactory.AuthenticationMethod)
                {
                    ...
                    case RequestedAuthType.oAuth:
                        ...
                        break;
                    case RequestedAuthType.AppSecretOAuth:
                        EwsProxyFactory.MailboxBeingAccessed = this.AutodiscoverEmailText.Text.Trim();  // override later in ewsproxyfactory
                        break;
                }
                ...
                EwsProxyFactory.UseAppSecretOAuth = rdoAppSecretOauth.Checked;
                EwsProxyFactory.AppSecretoAuthAppSecret = this.txtAppSecret.Text.Trim();
                EwsProxyFactory.AppSecretoAuthAuthority = this.txtAuthority.Text.Trim();
                EwsProxyFactory.AppSecretoAuthClientId = this.txtAppID.Text.Trim();
                EwsProxyFactory.AppSecretoAuthTenantId = this.txtTenantID.Text.Trim();
                EwsProxyFactory.AppSecretoAuthScope = this.txtScope.Text.Trim();
               ...
               // EwsProxyFactory.Password = this.txtPassword.Text.Trim();   // Don't keep.
                ...
                if (this.rdoAppSecretOauth.Checked)
                {
                    AuthenticationHelper oAH = new AuthenticationHelper();
                    string sBearerToken = string.Empty;
                    EwsProxyFactory.ServiceCredential = oAH.Do_OAuth(EwsProxyFactory.AppSecretoAuthTenantId, EwsProxyFactory.AppSecretoAuthClientId,EwsProxyFactory.AppSecretoAuthAppSecret,EwsProxyFactory.AppSecretoAuthAuthority,EwsProxyFactory.AppSecretoAuthScope,ref sBearerToken);
                    EwsProxyFactory.oBearerToken = sBearerToken;
        ...
        */
        private void SetAuthEnablement()
        {
            bool bUserSpecified = this.rdoCredentialsUserSpecified.Checked;
            bool bUseOAuth = this.rdoCredentialsOAuth.Checked;
            bool bUseAppSecretOAuth = this.rdoAppSecretOauth.Checked;
            ...
            this.lblAppID.Enabled = bUseAppSecretOAuth;
            this.lblAppSecret.Enabled = bUseAppSecretOAuth;
            this.lblTenantID.Enabled = bUseAppSecretOAuth;
            this.lblAppSecretAuthority.Enabled = bUseAppSecretOAuth;
            this.lblScope.Enabled = bUseAppSecretOAuth;

            this.txtAppID.Enabled = bUseAppSecretOAuth;
            this.txtAppSecret.Enabled = bUseAppSecretOAuth;
            this.txtTenantID.Enabled = bUseAppSecretOAuth;
            this.txtAuthority.Enabled = bUseAppSecretOAuth;
            this.txtScope.Enabled = bUseAppSecretOAuth;
        }
        ...
        private void radioAuthToken_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void rdoAppSecretOauth_CheckedChanged(object sender, EventArgs e)
        {
            SetAuthEnablement();
        }
    }
